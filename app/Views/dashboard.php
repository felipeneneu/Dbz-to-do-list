  ...
  <div class="bg-gray-300 h-[173px] w-full ">
    <div class="flex flex-row justify-between items-center w-full px-6 my-auto mx-auto h-full">
      <div class="text-base text-gray-800">
        <p>Olá! <span class="font-bold"><?= $userData->nome; ?></span></p>
      </div>
      <img src="<?= $_SESSION['avatar'] ?>" alt="" class="w-10 h-10 rounded-full object-cover">
    </div>
  ...
  <div class="px-6 text-gray-500 drop-shadow-md -mt-7">
    <div class="md:container md:mx-auto bg-gray-200 px-6 rounded-lg h-full py-6">
      <div class="flex flex-row justify-between items-center w-full ">
        <p class="font-bold">Nivel <?= $userData->lvl ?></p>
        <p><span class="font-bold"><?= $userData->xp ?></span> Pontos XP</p>
      </div>
      ...
      <p><span class="font-bold">1</span> Conquistas</p>
    </div>
  </div>
